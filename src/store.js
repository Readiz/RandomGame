...
export const CharTypes = [
    ...
    { id: 3, name: '예리한 태성', desc: '강화 성공시 50%의 확률로 대성공 합니다(성공시 추가로 1강 증가). 하지만 강화에 한번이라도 실패하면 게임오버(=강화 내구도 1) 입니다.' },
    { id: 4, name: '곽철용', desc: '무기 내구도가 2배(6회)입니다. 하지만 기본 강화 보장이 0이며, 강화 확률이 기본 확률 대비 80% 입니다.' },
];